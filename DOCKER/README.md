...
Official releases can be found [here](https://github.com/mihongtech/tendermint/releases).
...
- **Where to file issues:** <https://github.com/mihongtech/tendermint/issues>
...
To run a 4-node network, see the `Makefile` in the root of [the repo](https://github.com/mihongtech/tendermint/blob/master/Makefile) and run:
...
- Tendermint's license is [Apache 2.0](https://github.com/mihongtech/tendermint/blob/master/LICENSE).

## Contributing

Contributions are most welcome! See the [contributing file](https://github.com/mihongtech/tendermint/blob/master/CONTRIBUTING.md) for more information.
