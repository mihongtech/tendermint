...
func TestVoteVerify(t *testing.T) {
	...
	err = vote.Verify("test_chain_id", signature.GenPrivKey().PubKey())
...
func TestVoteString(t *testing.T) {
	...
	expected := `Vote{56789:C605D815A778 12345/02/SIGNED_MSG_TYPE_PRECOMMIT(Precommit) AEEC33A2B50B 000000000000 @ 2017-12-25T03:00:01.234Z}` //nolint:lll //ignore line length for tests
	if str != expected {
		t.Errorf("got unexpected string for Vote. Expected:\n%v\nGot:\n%v", expected, str)
	}

	str2 := examplePrevote().String()
	expected = `Vote{56789:C605D815A778 12345/02/SIGNED_MSG_TYPE_PREVOTE(Prevote) AEEC33A2B50B 000000000000 @ 2017-12-25T03:00:01.234Z}` //nolint:lll //ignore line length for tests
	if str2 != expected {
		t.Errorf("got unexpected string for Vote. Expected:\n%v\nGot:\n%v", expected, str2)
	}
}
