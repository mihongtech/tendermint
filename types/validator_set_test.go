...
func TestValidatorSetBasic(t *testing.T) {
	...
	assert.Equal(t, []byte{0x1a, 0xb2, 0x1d, 0x83, 0x55, 0xcf, 0xa1, 0x7f, 0x8e, 0x61,
		0x19, 0x48, 0x31, 0xe8, 0x1a, 0x8f, 0x22, 0xbe, 0xc8, 0xc7, 0x28, 0xfe, 0xfb,
		0x74, 0x7e, 0xd0, 0x35, 0xeb, 0x50, 0x82, 0xaa, 0x2b}, vset.Hash())
	// add
...
func randPubKey() crypto.PubKey {
	...
	return signature.GenPrivKey().PubKey()
}
