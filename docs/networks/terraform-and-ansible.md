...
script](https://github.com/mihongtech/tendermint/blob/master/networks/remote/integration.sh)
...
directory](https://github.com/mihongtech/tendermint/tree/master/networks/remote/ansible)
