...
(ABCI)](https://github.com/mihongtech/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/mihongtech/tendermint) (the
...
Types](https://github.com/mihongtech/tendermint/blob/master/abci/README.md#message-types).
