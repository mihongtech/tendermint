...
* Here are some common library labels for consistency:
    ...
    * tmcmd "github.com/mihongtech/tendermint/cmd/tendermint/commands"
    * tmcfg "github.com/mihongtech/tendermint/config/tendermint"
...
* When importing a pkg from the `tendermint/libs` directory, prefix the pkg alias with tm.
    * tmbits "github.com/mihongtech/tendermint/libs/bits"
